...
namespace Sinema_Dunyasi.Areas.Adminler.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        public MovieController(IGenreService genService, IMovieService MovieService, IFileService fileService, DatabaseContext databaseContext)
        {
        ...
        public IActionResult Add(Movie model)
        {
            ...
            if (model.ImageFile != null)
            {
                ...
                {
                    TempData["msg"] = "Fotoğraf kaydedilemedi";
                    return View(model);
                }
